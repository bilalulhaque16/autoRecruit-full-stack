...
const NavbarBookmarks = (props) => {
  ...
  // ** ComponentDidMount
  useEffect(() => {
    dispatch(navbarActions.getBookmarksRequest())
  }, [])
  ...
  const handleBookmarkUpdate = (id) =>
    dispatch(navbarActions.updateBookmarkedRequest(id))
  ...
  const handleInputChange = (e) => {
    ...
    dispatch(navbarActions.handleSearchQuery(e.target.value))
  }
