...
const VerticalLayout = (props) => {
  ...
  const layoutStore = useSelector((state) => state.layoutReducer)
  ...
  const setMenuCollapsed = (val) =>
    dispatch(layoutActions.handleMenuCollapsed(val))

  // ** Handles Content Width
  const setContentWidth = (val) =>
    dispatch(layoutActions.handleContentWidth(val))

  // ** Handles Content Width
  const setIsHidden = (val) => dispatch(layoutActions.handleMenuHidden(val))
